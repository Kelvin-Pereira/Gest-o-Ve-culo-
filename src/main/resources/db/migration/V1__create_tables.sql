...
(
    ...
    RENAVAM                 VARCHAR2(10) NOT NULL,
    STATUS                  VARCHAR2(1) NOT NULL CHECK (STATUS IN ('S', 'N')),
    MODELO_ID               NUMBER NOT NULL,
    TIPO_COMBUSTIVEL        VARCHAR2(20) NOT NULL CHECK (TIPO_COMBUSTIVEL IN ('GASOLINA_ETANOL', 'GASOLINA', 'DIESEL', 'ELÉTRICO', 'HIBRIDO' 'ETANOL','GNV')),
